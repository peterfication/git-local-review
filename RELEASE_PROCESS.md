...
6. Create a tag on this commit in the format "x.x.x"
7. Push the branch with the tag, create a pull request and merge it after the CI succeeded (`git push origin release-x-x-x && git push origin x.x.x`)
